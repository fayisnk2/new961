...
REQ_CHANNEL_ONE = environ.get("REQ_CHANNEL_ONE", -1002026461119)
REQ_CHANNEL_TWO = environ.get("REQ_CHANNEL_TWO", -1001989382228)
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001989382228'))
